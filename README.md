...
- *"What is the total move-in cost for a AED 90,000 flat?"*
- *"Compare JVC vs Dubai Marina for a young professional"*
- *"Which areas have metro access under AED 80,000/year?"*
...
| | LangChain (`app.py`) | LlamaIndex (`app_llama.py`) |
|---|---|---|
...
```dockerfile
CMD ["python", "app_llama.py"]   # LlamaIndex (active)
CMD ["python", "app.py"]         # LangChain (backup)
```
...
**Nipun Kavinda** — AI Accelerator Bootcamp, Decoding Data Science  
Dubai, UAE 🇦🇪
...
*Built as part of the AI Accelerator Bootcamp — From AI Curious to AI Builder*
